...
(The more attributes theere is the more messy it becomes and the altering code is not reusable.)
...
(Names of new attributes that have to be altered in the same way can just be added to proper sets
